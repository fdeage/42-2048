...
/*   Updated: 2015/03/02 21:22:31 by fdeage           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	reinit_front_colors(void)
{
	...
	init_color(COLOR_F_8, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_16, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_32, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_ELSE, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_64, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_128, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_256, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_512, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_1024, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_2048, r(0xff), r(0xff), r(0xff));
	init_color(COLOR_F_4096, r(0xff), r(0xff), r(0xff));
}
...
void		reinit_colors(void)
{
	reinit_front_colors();
	init_color(COLOR_BACK, r(0x20), r(0x20), r(0x20));
//	init_color(COLOR_0, r(0x25), r(0x20), r(0x20));
//	init_color(COLOR_B_0, r(0xcc), r(0xc0), r(0xb3));
	...
	//init_color(COLOR_ELSE, r(0xf6), r(0x5e), r(0x3b));
